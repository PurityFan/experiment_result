...
get_acc_list(file_dir='BOHB_CIFAR10_PAI_4GPU_2concu/experiment.json', curve_color="g--") # green
get_acc_list(file_dir='Random_CIFAR10_PAI_4GPU_2concu/experiment.json', curve_color="r--") #red
get_acc_list(file_dir='TPE_CIFAR10_PAI_4GPU_2concu/experiment.json', curve_color="k--") # black
