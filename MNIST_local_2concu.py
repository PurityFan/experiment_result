...
get_acc_list(file_dir='BOHB_MNIST_243_1_Local_2concu/experiment.json', curve_color="g--") # green
get_acc_list(file_dir='Hyperband_MNIST_243_Local_2concu/experiment.json', curve_color="b--") # blue
get_acc_list(file_dir='Random_MNIST_Local_2concu/experiment.json', curve_color="r--") #red
get_acc_list(file_dir='TPE_MNIST_Local_2concu/experiment.json', curve_color="k--") # black
